		...
		namespace DIGITAL
		{
			...
			void ROT_2SKEWS(dreg_t reg, int rotation_steps)
			{
				...
				if(current_rotation > 0)
				{
					...
					{
						IMGTF::SKEW::DIGITAL::STEP_SKEWX_CW_S6(n);
						IMGTF::SKEW::DIGITAL::STEP_SKEWY_CW_S6(n);
					}
				}
				else
				{
					for(int n = 0 ; n < -current_rotation ; n++)
					{
						IMGTF::SKEW::DIGITAL::STEP_SKEWX_ACW_S6(n);
						IMGTF::SKEW::DIGITAL::STEP_SKEWY_ACW_S6(n);
					}
				}
			...
			int STEP_ROT_2SKEWS(dreg_t reg, int current_rot_value, bool rot_ACW)
			{
				...
				if(current_rot_value > 0)
				{
					if(!rot_ACW)
					{
						IMGTF::SKEW::DIGITAL::	STEP_SKEWX_CW_S6(current_rot_value);
						IMGTF::SKEW::DIGITAL::	STEP_SKEWY_CW_S6(current_rot_value);
						current_rot_value = current_rot_value + 1;
					}
					else
					{
						current_rot_value = current_rot_value - 1;
						IMGTF::SKEW::DIGITAL::	STEP_SKEWY_ACW_S6(current_rot_value);
						IMGTF::SKEW::DIGITAL::STEP_SKEWX_ACW_S6(current_rot_value);
					}
				}
				else
				{
